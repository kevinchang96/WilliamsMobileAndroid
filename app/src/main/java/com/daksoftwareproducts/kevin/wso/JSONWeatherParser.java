...
public class JSONWeatherParser {
    ...
    // Post-condition: parses through the string data to create a weather object
    // Parameters: data represents the JSON weather data in string form
    ...
    // Post-condition: parses through the string data to create a forecast object
    // Parameters: data represents the JSON weather data in string form
    public static WeatherForecast getForecastWeather(String data) throws JSONException  {
        ...
        for (int i=0; i < jArr.length(); i++) {
            ...
            // Pressure & Humidity
            df.weather.currentCondition.setPressure((float) jTempObj.getDouble("pressure"));
            df.weather.currentCondition.setHumidity((float) jTempObj.getDouble("humidity"));
            ...
            try {
                ...
                df.weather.seticonData( (new WeatherHttpClient()).getImage(df.weather.currentCondition.getIcon()));
            } catch (Exception e) {
                e.printStackTrace();
            }

            df.date = (String) jDayForecast.getString("dt_txt");
