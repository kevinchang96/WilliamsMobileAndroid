...
public class WeatherHttpClient {
    ...
    private static String BASE_FORECAST_URL = "http://api.openweathermap.org/data/2.5/forecast?q=";
    //private static String BASE_FORECAST_URL = "http://api.openweathermap.org/data/2.5/forecast/daily?mode=json&q=";

    private static String apikey = "5001beb19a0b0fa04fb3aa969e984f68";
    ...
    public String getForecastWeatherData(String location, String lang, String sForecastDayNum) {
        ...
        try {
            ...
            //url = url + "&cnt=" + forecastDayNum + "&APPID=" + apikey;
            url = url + "&APPID=" + apikey;
            System.out.println(url);
            con = (HttpURLConnection) ( new URL(url)).openConnection();
            con.setRequestMethod("GET");
